...
import connectors.parsers.TaskListEmploymentDataParser._
...
class EmploymentTaskListDataConnector @Inject()(val http: HttpClientV2, val config: AppConfig)
  ...
  def get(taxYear: Int,nino:String)(implicit hc: HeaderCarrier): Future[TaskListSectionResponseModel] = {
    ...
    val taskListDataUrl: String = config.employmentBaseUrl + s"/income-tax-employment/$taxYear/tasks/$nino"
