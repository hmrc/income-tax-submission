...
object SubmittedGainsParser extends APIParser with Logging {
  type InsurancePoliciesResponseModel = Either[APIErrorModel, Option[InsurancePoliciesModel]]

  override val parserName: String = "SubmittedGainsParser"
  override val service: String = "income-tax-additional-information"

  implicit object SubmittedGainsHttpReads extends HttpReads[InsurancePoliciesResponseModel] {
    override def read(method: String, url: String, response: HttpResponse): InsurancePoliciesResponseModel = {
