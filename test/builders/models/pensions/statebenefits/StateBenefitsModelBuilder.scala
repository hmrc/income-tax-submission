...
import builders.models.pensions.statebenefits.StateBenefitsBuilder.aStateBenefits
...
object StateBenefitsModelBuilder {
  ...
  val aStateBenefitsModel: StateBenefitsModel = StateBenefitsModel(
    stateBenefits = Some(aStateBenefits),
    customerAddedStateBenefits = Some(aStateBenefits)
  )
}
