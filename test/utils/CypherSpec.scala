...
import utils.Cypher.{bigDecimalCypher, booleanCypher, stringCypher}

class CypherSpec extends AnyWordSpec with MockFactory with Matchers with BeforeAndAfterEach {
