...
import models.pensions.{Charge, CustomerStateBenefit, CustomerStateBenefits, LifetimeAllowance, OverseasPensionContributions, OverseasSchemeProvider, PensionCharges, PensionContributions, PensionReliefs, PensionSavingsTaxCharges, PensionSchemeOverseasTransfers, PensionSchemeUnauthorisedPayments, PensionsModel, Reliefs, StateBenefit, StateBenefits, StateBenefitsModel}
...
trait IntegrationSpec extends AnyWordSpec with Matchers with BeforeAndAfterEach with BeforeAndAfterAll with GuiceOneServerPerSuite
  ...
  val fullPensionsModel = PensionsModel(
    ...
    Some(StateBenefitsModel(
      ...
      Some(CustomerStateBenefits(
        incapacityBenefit = Some(List(CustomerStateBenefit(
        ...
        statePension = Some(CustomerStateBenefit(
        ...
        statePensionLumpSum = Some(CustomerStateBenefit(
        ...
        employmentSupportAllowance = Some(List(CustomerStateBenefit(
        ...
        jobSeekersAllowance  = Some(List(CustomerStateBenefit(
        ...
        bereavementAllowance = Some(CustomerStateBenefit(
        ...
        otherStateBenefits = Some(CustomerStateBenefit(
